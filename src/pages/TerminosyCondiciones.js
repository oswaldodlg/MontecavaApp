  ...
  return (
    <Box className={classes.container}>
      ...
      <Grid container className={classes.containerText}>
        ...
        11. Plataforma: El Sitio web https://www.montecava.com.mx/ o las aplicaciones móviles en iOS o Android denominadas “MONTECAVA APP”, según corresponda el Uso.<br />
        ...
        13. Sitio web: https://www.montecava.com.mx/ <br />
        ...
        16. Usuario: Quién haga Uso del Sitio web https://www.montecava.com.mx/ o las aplicaciones “MONTECAVA APP” en iOS o Android.<br />
        </Typography>
        </Grid>
        <Grid item sx={{padding: '2vh 0'}}>
        <Typography variant='h6' sx={{fontWeight: 'bold'}}>
        ...
        <br /><br />Ahora bien, será responsabilidad y obligación del Usuario revisar el Aviso de Privacidad, el cual estará a su disposición, en todo momento actualizado en el Sitio web de https://www.montecava.com.mx/. La no manifestación de inconformidad por parte del Usuario representa su consentimiento y autorización al mismo en todos sus términos.
        </Typography>
        </Grid>
        <Grid item sx={{padding: '2vh 0'}}>
        <Typography variant='h6' sx={{fontWeight: 'bold'}}>
