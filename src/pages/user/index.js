      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Grid
            ...
            xs={12}
          >
          {subscriptionData.isActive ? <UserDocumentDisplay currentDocView={currentDocView} id={user.uid} docs={data.Documentos} credentials={data.credentials} /> : <Typography>Tu membresia no está activa</Typography>}
          </Grid>
        </Grid>
        : 
